  ...
  return (
    <>
      ...
      <section ref={ref} style={{
        ...
        {/* Ambient rings */}
        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 3, delay: 0.5, ease: 'easeOut' }}
        ...
        <motion.div initial={{ opacity: 0, scale: 0.7 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 3, delay: 0.8, ease: 'easeOut' }}
        ...
        <motion.div style={{ opacity: heroOpacity, scale: heroScale, y: heroY, position: 'relative', zIndex: 10, width: '100%' }}>
          <div style={{
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1 }}
              ...
              />
              <span style={{ fontSize: 'clamp(10px,1.3vw,12px)', fontWeight: 600, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.35)' }}>
            ...
            {/* Headline */}
            <h1 style={{
              margin: '0 0 clamp(20px,3.5vw,36px)', padding: 0,
              fontFamily: '"Roboto Slab", Georgia, serif',
              fontWeight: 900, fontSize: 'clamp(40px, 9.5vw, 110px)',
              lineHeight: 1.0, letterSpacing: '-0.04em', overflow: 'hidden',
            }}>
            ...
            <motion.p
              ...
              style={{ fontSize: 'clamp(14px,1.8vw,19px)', color: 'rgba(255,255,255,0.32)', maxWidth: 520, margin: '0 auto clamp(36px,5vw,60px)', lineHeight: 1.8, fontWeight: 400 }}
            >
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
                ...
                <Link href="/agendamento" style={{ textDecoration: 'none' }}>
                  <motion.button
                    whileHover={{ scale: 1.06, boxShadow: '0 0 90px rgba(97,206,112,0.55), 0 24px 60px rgba(0,0,0,0.4)' }}
                    whileTap={{ scale: 0.97 }}
                    style={{
                      ...
                      fontFamily: '"Roboto Slab", Georgia, serif', whiteSpace: 'nowrap',
                    }}
                  >
                ...
                <Link href="/segunda-chamada" style={{ textDecoration: 'none' }}>
                  <motion.button
                    whileHover={{ scale: 1.06, boxShadow: '0 0 60px rgba(64,84,178,0.45), 0 24px 60px rgba(0,0,0,0.4)', background: 'rgba(64,84,178,0.22)' }}
                    whileTap={{ scale: 0.97 }}
                    style={{
                      display: 'inline-flex', alignItems: 'center', gap: 12,
                      ...
                      fontSize: 'clamp(14px,1.6vw,17px)', fontWeight: 800,
                      cursor: 'pointer', letterSpacing: '-0.02em',
                      boxShadow: '0 0 40px rgba(64,84,178,0.2)',
                      fontFamily: '"Roboto Slab", Georgia, serif', whiteSpace: 'nowrap',
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2.2 }}>
                <Link href="/secretaria/login" style={{
                  ...
                  borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: 2, transition: 'color 0.3s',
                }}>
                  Área da Secretaria →
                </Link>
              </motion.div>
            ...
            <motion.div
              ...
              style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 'clamp(24px,5vw,72px)', marginTop: 'clamp(52px,8vw,96px)', flexWrap: 'wrap' }}
            >
              {[
                ...
                >
                  <div style={{ fontSize: 'clamp(22px,3vw,32px)', fontWeight: 900, color: '#61CE70', fontFamily: '"Roboto Slab", serif', letterSpacing: '-0.03em', textShadow: '0 0 30px rgba(97,206,112,0.4)' }}>{s.value}</div>
