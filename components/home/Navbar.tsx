...
import { CalendarDays, Shield, Menu, X } from 'lucide-react'
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Link href="/agendamento" style={{ textDecoration: 'none' }}>
              <motion.button
                whileHover={{ scale: 1.04, boxShadow: '0 8px 30px rgba(97,206,112,0.55)' }}
                whileTap={{ scale: 0.97 }}
                style={{
                  display: 'flex', alignItems: 'center', gap: 8,
                  background: 'linear-gradient(135deg, #23A455, #61CE70)',
                  color: '#041809', border: 'none',
          ...
          >
            <Link href="/agendamento" style={{ textDecoration: 'none' }} onClick={() => setMenuOpen(false)}>
              <button style={{
                ...
                background: 'linear-gradient(135deg, #23A455, #61CE70)',
                color: '#041809', border: 'none', borderRadius: 14,
                padding: '15px 24px', fontSize: 16, fontWeight: 800,
                cursor: 'pointer', fontFamily: '"Roboto Slab", serif',
              }}>
            ...
            <Link href="/secretaria/login" style={{ textDecoration: 'none' }} onClick={() => setMenuOpen(false)}>
              <button style={{
                ...
                borderRadius: 14, padding: '14px 24px', fontSize: 15, fontWeight: 500,
                cursor: 'pointer',
              }}>
